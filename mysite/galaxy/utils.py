...
class AddTestConstValues:
    ...
    texts = {'GSEListening': '''В разделе аудирования ОГЭ Вам предлагается прослушать несколько текстов 
                             ...
                             Задания, где Вы не выбираете вариант ответа будут считаться неверно выполненными. 
                             ...
                             и Вы не успеете прослушать его до конца до истечении таймера.''',

            'GSEReading': '''В разделе чтения ОГЭ Вам предлагается выполнить 8 заданий на понимание прочитанных текстов.
                             Как только Вы попадете на страницу задания- запустится таймер для выполнения теста,
                             таймер не обнулится при обновлении страницы или выходе из личного кабинета. 
                             По истечении времени выполнение теста закончится автоматически. 
                             Задания, где Вы не выбираете вариант ответа будут считаться неверно выполненными.''',

            'GSEGrammar and Vocabulary': '''В разделе грамматики ОГЭ Вам предлагается выполнить 15 заданий на понимание прочитанных текстов.
                             Как только Вы попадете на страницу задания- запустится таймер для выполнения теста,
                             таймер не обнулится при обновлении страницы или выходе из личного кабинета. 
                             По истечении времени выполнение теста закончится автоматически. 
                             Задания, где Вы не выбираете вариант ответа будут считаться неверно выполненными.''',
            ...
            'GSEWriting': '''Для ответа на задание в письменной части ОГЭ, Вам необходимо приготовить лист формата А4 и ручку. 
                             Вам будет необходимо написать от руки Ваш ответ, 
                             сфотографировать его и прикрепить фотографию в поле "Ответ". 
                             Как только Вы попадете на страницу задания- запустится таймер для выполнения теста,
                             таймер не обнулится при обновлении страницы или выходе из личного кабинета. 
                             По истечении времени выполнение теста закончится автоматически. 
                             Будьте внимательны, заложите время для фотографирования Вашего ответа и его прикрепления.
            ...
            'USEListening': '''В разделе аудирования ЕГЭ Вам предлагается прослушать несколько текстов 
            ...
            'USEReading': '''В разделе чтения ЕГЭ Вам предлагается выполнить 9 заданий на понимание прочитанных текстов.
                             Как только Вы попадете на страницу задания- запустится таймер для выполнения теста,
                             таймер не обнулится при обновлении страницы или выходе из личного кабинета. 
                             По истечении времени выполнение теста закончится автоматически. 
                             Задания, где Вы не выбираете вариант ответа будут считаться неверно выполненными. ''',
            ...
            'USEWriting': '''Для ответа на задания в письменной части ЕГЭ, Вам необходимо приготовить 2 листа формата А4 и ручку. 
                             Вам будет необходимо написать от руки Ваш ответ, сфотографировать его 
                             и прикрепить фотографии в поле "Ответ". 
                             Как только Вы попадете на страницу задания- запустится таймер для выполнения теста,
                             таймер не обнулится при обновлении страницы или выходе из личного кабинета. 
                             По истечении времени выполнение теста закончится автоматически. 
                             Будьте внимательны, заложите время для фотографирования Ваших ответов и их прикрепления.
                             Обратите внимание также на необходимость соблюдения указанного объёма электронного письма. 
                             Письмо недостаточного объёма, а также часть текста электронного письма, 
                             превышающая требуемый объём, не оцениваются.'''}
...
def confirm_student_check(user):
...
def open_email_notification(group, assessment_date):
    from django.core.mail import send_mail
    email_subject = 'New Assessment'
    message = 'Your group will have assessment at' + assessment_date
